/*
screva um programa que verifica se um CPF é válido. Esse CPF é informado no primeiro argumento de linha de comando.
...
public class U3A06E08_verificaCpf {
    public static void main(String[] args){
        ...
        for(int i=0;i<cpfTamanho();i++){
            if(n>=2){
                resultado1 += cpfDigitos[i]*n;
            }
            // se o índice for 1, inicia a soma do resultado 2 que é multiplicar a sequencia de 11 a 2
            if(n>=1){
                resultado2 += cpfDigitos[i]*(n+1);
                n--;
            }
        }

        // multiplicando o resultado1 por 10 e obtendo o resto da divisão por 11:
        int resultado3 = (resultado1*10)%11;
        resultado3 %=10; // garantindo que se for 10 será substituído por 10

        // multiplicando o resultado 2 por 10 e obtendo o resto da divisão por 11
        int resultado4 = (resultado2*10)%11;
        resultado4 %= 10; // garantindo que se for 10 será substituído por 10

        if(resultado3==cpfDigitos[9] & resultado4==cpfDigitos[10]){
